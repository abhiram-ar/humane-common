...
export type FriendshipDecliendEvent = RootAppEvent<typeof FriendshipEventsTypes.FRIEND_REQ_DECLIED, FriendshipEventPayload>;
export type FriendshipDeletedEvent = RootAppEvent<typeof FriendshipEventsTypes.FRIENDSHIP_DELETED, FriendshipEventPayload>;
export type UserServiceEvents = UserPasswordRecoveryRequestEvent | UserSignupEvent | UserCreatedEvent | UserUpdatedEvent | UserAvatarKeyUpdatedEvent | UserCoverPhotoKeyUpdatedEvent | UserBlockStatusUpdatedEvent | FriendReqSendEvent | FriendReqCancelledEvent | FriendReqAcceptedEvent | FriendshipDecliendEvent | FriendshipDeletedEvent;
export {};
